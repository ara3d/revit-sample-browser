...
| **Source** | `src/ContextualAnalyticalModel/CS/CreateAreaLoadWithRefPoint.cs` |
...
- MCP descriptor: `docs/mcp/ContextualAnalyticalModel/createarealoadwithrefpoint.json`
