...
| **Class** | `Command` |
| **Source** | `src/CreateBeamSystem/CS/Command.cs` |
| **SDK ReadMe** | `src/CreateBeamSystem/CS/ReadMe_CreateBeamSystem.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/CreateBeamSystem/createbeamsystem.json`
