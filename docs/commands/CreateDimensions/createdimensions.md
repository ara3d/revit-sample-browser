...
| **Class** | `Command` |
| **Source** | `src/CreateDimensions/CS/Command.cs` |
| **SDK ReadMe** | `src/CreateDimensions/CS/ReadMe_CreateDimensions.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/CreateDimensions/createdimensions.json`
