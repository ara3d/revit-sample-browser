...
| **Class** | `Command` |
| **Source** | `src/CurtainWallGrid/CS/Command.cs` |
| **SDK ReadMe** | `src/CurtainWallGrid/CS/ReadMe_CurtainWallGrid.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/CurtainWallGrid/curtainwallgrid.json`
