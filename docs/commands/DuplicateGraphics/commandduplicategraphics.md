...
| **Source** | `src/DuplicateGraphics/CS/Command.cs` |
| **SDK ReadMe** | `src/DuplicateGraphics/CS/ReadMe_DuplicateGraphics.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/DuplicateGraphics/commandduplicategraphics.json`
