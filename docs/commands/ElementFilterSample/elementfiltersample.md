...
| **Class** | `Command` |
| **Source** | `src/ElementFilterSample/CS/Command.cs` |
| **SDK ReadMe** | `src/ElementFilterSample/CS/ReadMe_ViewFilters.rtf` |
| **MCP rating** | 5/5 |
...
- MCP descriptor: `docs/mcp/ElementFilterSample/elementfiltersample.json`
