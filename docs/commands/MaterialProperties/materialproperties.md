...
| **Source** | `src/MaterialProperties/CS/MaterialProperties.cs` |
| **SDK ReadMe** | `src/MaterialProperties/CS/ReadMe_MaterialProperties.rtf` |
| **MCP rating** | 5/5 |
...
- MCP descriptor: `docs/mcp/MaterialProperties/materialproperties.json`
