...
| **Class** | `Command` |
| **Source** | `src/MaterialQuantities/CS/MaterialQuantities.cs` |
| **SDK ReadMe** | `src/MaterialQuantities/CS/ReadMe_MaterialQuantities.rtf` |
| **MCP rating** | 5/5 |
...
- MCP descriptor: `docs/mcp/MaterialQuantities/materialquantities.json`
