...
| **Class** | `Command` |
| **Source** | `src/SpotDimension/CS/Command.cs` |
| **SDK ReadMe** | `src/SpotDimension/CS/ReadMe_SpotDimension.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/SpotDimension/spotdimension.json`
