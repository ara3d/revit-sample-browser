...
| **Class** | `Command` |
| **Source** | `src/StairsAutomation/CS/Command.cs` |
| **SDK ReadMe** | `src/StairsAutomation/CS/Readme_StairsAutomationSample.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/StairsAutomation/stairsautomation.json`
