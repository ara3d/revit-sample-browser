...
| **Class** | `Command` |
| **Source** | `src/ViewTemplateCreation/CS/Command.cs` |
| **SDK ReadMe** | `src/ViewTemplateCreation/CS/Readme_ViewTemplateCreation.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/ViewTemplateCreation/viewtemplatecreation.json`
