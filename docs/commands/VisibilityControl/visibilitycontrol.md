...
| **Class** | `Command` |
| **Source** | `src/VisibilityControl/CS/Command.cs` |
| **SDK ReadMe** | `src/VisibilityControl/CS/ReadMe_VisibilityControl.rtf` |
| **MCP rating** | 4/5 |
...
- MCP descriptor: `docs/mcp/VisibilityControl/visibilitycontrol.json`
