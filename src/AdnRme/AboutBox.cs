    ...
    partial class AboutBox : Form
    {
        ...
        public string AssemblyTitle
        {
            get
            {
                ...
                var a = GetFirstCustomAttribute(typeof(AssemblyTitleAttribute));
                // If there is at least one Title attribute
                if (null != a)
                {
                    // Select the first one
                    var titleAttribute = (AssemblyTitleAttribute)a;
        ...
        public string AssemblyDescription
        {
            get
            {
                ...
                var a = GetFirstCustomAttribute(typeof(AssemblyDescriptionAttribute));
        ...
        public string AssemblyProduct
        {
            get
            {
                ...
                var a = GetFirstCustomAttribute(typeof(AssemblyProductAttribute));
        ...
        public string AssemblyCopyright
        {
            get
            {
                ...
                var a = GetFirstCustomAttribute(typeof(AssemblyCopyrightAttribute));
        ...
        public string AssemblyCompany
        {
            get
            {
                ...
                var a = GetFirstCustomAttribute(typeof(AssemblyCompanyAttribute));
