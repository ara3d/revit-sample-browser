...
namespace AdnRme
{
    ...
    public class CmdResetDemo : IExternalCommand
    {
        ...
        private void SetSpaceCfmPerSfToZero(Document doc)
        {
            ...
            var s = "{0} of " + n.ToString() + " spaces reset...";

            using ProgressForm pf = new("Reset parameter", s, n);
        ...
        private void ResetSupplyAirTerminals(Document doc)
        {
            ...
            var s = "{0} of " + n.ToString() + " terminals reset...";
            var caption = "Resetting Supply Air Termainal Flows and Sizes";
