...
namespace Ara3D.RevitSampleBrowser.Common.Documents.Query.Parser.Commands
{
    ...
    {
        private static readonly AutocompleteItem AutocompleteItem = new("owned", "owned", "select elements which are owned by a active view", AutocompleteItemGroups.Commands);
