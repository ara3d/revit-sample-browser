   ...
   public class AddAssociation : IExternalCommand
   {
      ...
      public virtual Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
      {
         ...
         using (var trans = new Transaction(doc, "Revit.SDK.Samples.AddRelationBetweenPhysicalAndAnalyticalElements"))
         {
            ...
            var analyticalElementId = ContextualAnalyticalModel.Utilities.GetSelectedObject(activeDoc, "Please select analytical element");
            var physicalElementId = ContextualAnalyticalModel.Utilities.GetSelectedObject(activeDoc, "Please select physical element");
