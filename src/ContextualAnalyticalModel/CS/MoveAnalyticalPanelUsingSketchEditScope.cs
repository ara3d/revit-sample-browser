                  ...
                  foreach (CurveArray curveArray in sketch.Profile)
                  {
                     ...
                     foreach (Curve curve in curveArray)
                     {
                        ...
                        if (line != null)
                        {
                           ...
                           var offset = 5.0;
                           var newLineStart = new XYZ(line.GetEndPoint(0).X + offset, line.GetEndPoint(0).Y + offset, 0);
                           var newLineEnd = new XYZ(line.GetEndPoint(1).X + offset, line.GetEndPoint(1).Y + offset, 0);
