      ...
      public void DrawGraphics(System.Drawing.Graphics graphics, System.Drawing.Pen drawPen)
      {
         for (var i = 0; i < m_curve3Ds.Count; i++)
         {
            ...
            for (var j = 0; j < (points.Count - 1); j++)
            {
               ...
               var startPoint = new System.Drawing.PointF((float)points[j].X, (float)points[j].Y);
               var endPoint = new System.Drawing.PointF((float)points[j + 1].X, (float)points[j + 1].Y);
