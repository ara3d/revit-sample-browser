   ...
   class RevitElementDrawingServer : IDirectContext3DServer
   {
      ...
      public void RenderScene(Autodesk.Revit.DB.View view, DisplayStyle displayStyle)
      {
         try
         {
            ...
            var faceBufferStorage = DrawContext.IsTransparentPass() ? m_transparentFaceBufferStorage : m_nonTransparentFaceBufferStorage;
            ...
            foreach (Face face in solid.Faces)
            {
               if (face.Area > 1e-06)
               {
                  ...
                  if (materialId != ElementId.InvalidElementId)
                  {
                     ...
                     var transparency0To255 = (uint)((float)transparency0To100 / 100f * 255f);
      ...
      private void ProcessFaces(RenderingPassBufferStorage bufferStorage)
      {
         ...
         var vertexBufferSizeInFloats = (useNormals ? VertexPositionNormalColored.GetSizeInFloats() : VertexPositionColored.GetSizeInFloats()) *
