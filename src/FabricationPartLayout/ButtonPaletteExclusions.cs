    ...
    public class ButtonPaletteExclusions : IExternalCommand
    {
            ...
            , ref string message, ElementSet elements)
        {
            try
            {
                ...
                using Transaction tr = new(doc, "Set button and palette exclusions");
                tr.Start();
                ...
                {
                    selectedService.SetServicePaletteExclusions([roundPaletteIndex]);
                }
                else
                {
                ...
                TaskDialog td = new("Button and Palette Exclsuions")
                {
