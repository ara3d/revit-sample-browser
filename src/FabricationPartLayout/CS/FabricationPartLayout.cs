          ...
          , ref string message, ElementSet elements)
      {
         try
         {
            ...
            using (var tr = new Transaction(m_doc, "Create Layout"))
            {
               ...
               var connId = config.LocateFabricationConnector("Duct - S&D", "S&D", ConnectorDomainType.Undefined, ConnectorProfileType.Rectangular);
               ...
               var prodEntry_curvedBoot1 = pt_curvedBoot1.get_Parameter(BuiltInParameter.FABRICATION_PRODUCT_ENTRY);
               ...
               var prodEntry_curvedBoot2 = pt_curvedBoot2.get_Parameter(BuiltInParameter.FABRICATION_PRODUCT_ENTRY);
