...
namespace Revit.SDK.Samples.CreateAirHandler.CS
{
   ...
   public class Command : IExternalCommand
   {
      ...
      private void CreateConnectors()
      {
         ...
         var connReturnAir = ConnectorElement.CreateDuctConnector(m_document, DuctSystemType.ReturnAir, ConnectorProfileType.Rectangular, m_planarFaces[0].Reference);
         ...
         var connSupplyHydronic = ConnectorElement.CreatePipeConnector(m_document, PipeSystemType.SupplyHydronic, m_planarFaces[0].Reference);
         ...
         var connReturnHydronic = ConnectorElement.CreatePipeConnector(m_document, PipeSystemType.ReturnHydronic, m_planarFaces[0].Reference);
