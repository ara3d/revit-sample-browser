...
namespace Revit.SDK.Samples.FoundationSlab.CS
{
    ...
    class Sketch
    {
        ...
        public static void DrawProfile(Graphics graphic, RectangleF rclip, Collection<RegularSlab> baseSlabList)
        {
            ...
            var yellowPen = new Pen(System.Drawing.Color.Yellow, (float)0.05);  // For floors' profiles.
            var greenPen = new Pen(System.Drawing.Color.Green, (float)0.2); // For octagonal profiles.
