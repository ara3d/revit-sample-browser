...
namespace Revit.SDK.Samples.FrameBuilder.CS
{
    ...
    public class FrameData
    {
        ...
        double m_frameOriginAngle;		// the angle to rotate around bottom left point
        ...
        /// </summary>
        public FrameTypesMgr ColumnSymbolsMgr => m_columnSymbolsMgr;

        /// <summary>
        /// object manage all beam types
        /// </summary>
        public FrameTypesMgr BeamSymbolsMgr => m_beambracesSymbolsMgr;

        /// <summary>
        /// object manage all brace types
        /// </summary>
        public FrameTypesMgr BraceSymbolsMgr => m_beambracesSymbolsMgr;
        ...
        {
            get => m_frameOriginAngle;
            set => m_frameOriginAngle = value;
        }

        /// <summary>
        /// column's type
        /// </summary>
        public FamilySymbol ColumnSymbol => m_columnSymbol;

        /// <summary>
        /// beam's type
        /// </summary>
        public FamilySymbol BeamSymbol => m_beamSymbol;

        /// <summary>
        /// brace's type
        /// </summary>
        public FamilySymbol BraceSymbol => m_braceSymbol;

        /// <summary>
        /// list of all levels in the ordr of Elevation
        /// </summary>
        public SortedList<double, Level> Levels => m_levels;

        /// <summary>
        /// the number of levels before invoke external command
        /// </summary>
        public int OriginalLevelSize => m_originalLevelSize;
