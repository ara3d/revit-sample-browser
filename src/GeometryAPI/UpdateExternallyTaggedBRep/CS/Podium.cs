...
namespace RevitMultiSample.UpdateExternallyTaggedBRep.CS
{
    internal class Podium
    {
        ...
        private void UpdatePodiumDimensions(double width, double height, double depth)
        {
            m_podiumWidth = width;
        ...
        public ExternallyTaggedBRep CreateStairs()
        {
            ...
            var faceRiser2Id = brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(riser2, null),
                false /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceRiser2"), faceRiser2Id);
            var faceRiser3Id = brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(riser3, null),
                false /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceRiser3"), faceRiser3Id);
            var faceBackId =
                brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(back, null), true /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceBack"), faceBackId);
            var faceBottomId =
                brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(bottom, null), true /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceBottom"), faceBottomId);
            var faceTread1Id = brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(tread1, null),
                false /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceTread1"), faceTread1Id);
            var faceTread2Id = brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(tread2, null),
                false /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceTread2"), faceTread2Id);
            var faceTopId =
                brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(top, null), false /*bFaceIsReversed*/);
            persistentIds.AddSubTag(new ExternalGeometryId("faceTop"), faceTopId);
            var faceLeftId =
                brepBuilder.AddFace(BRepBuilderSurfaceGeometry.Create(left, null), true /*bFaceIsReversed*/);
            ...
            var edgeBottomRight = BRepBuilderEdgeGeometry.Create(new XYZ(m_halfPodiumWidth, m_riser1DepthPos, 0),
                new XYZ(m_halfPodiumWidth, m_halfPodiumDepth, 0));
            var edgeBottomBack = BRepBuilderEdgeGeometry.Create(new XYZ(m_halfPodiumWidth, m_halfPodiumDepth, 0),
                new XYZ(-m_halfPodiumWidth, m_halfPodiumDepth, 0));
            ...
            var edgeTread1Front = BRepBuilderEdgeGeometry.Create(
                ...
                new XYZ(m_halfPodiumWidth, m_riser1DepthPos, m_stepHeight));
            var edgeTread1Right = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser1DepthPos, m_stepHeight),
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight));
            var edgeTread1Back = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight),
                new XYZ(-m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight));
            var edgeTread1Left = BRepBuilderEdgeGeometry.Create(
                new XYZ(-m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight),
                new XYZ(-m_halfPodiumWidth, m_riser1DepthPos, m_stepHeight));
            ...
            var edgeTread2Front = BRepBuilderEdgeGeometry.Create(
                ...
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight * 2));
            var edgeTread2Right = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight * 2),
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2));
            var edgeTread2Back = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2),
                new XYZ(-m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2));
            var edgeTread2Left = BRepBuilderEdgeGeometry.Create(
                new XYZ(-m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2),
                new XYZ(-m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight * 2));
            ...
            var edgeTopFront = BRepBuilderEdgeGeometry.Create(
                ...
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_podiumHeight));
            var edgeTopRight = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_podiumHeight),
                new XYZ(m_halfPodiumWidth, m_halfPodiumDepth, m_podiumHeight));
            var edgeTopBack = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_halfPodiumDepth, m_podiumHeight),
                new XYZ(-m_halfPodiumWidth, m_halfPodiumDepth, m_podiumHeight));
            var edgeTopLeft = BRepBuilderEdgeGeometry.Create(
                new XYZ(-m_halfPodiumWidth, m_halfPodiumDepth, m_podiumHeight),
                new XYZ(-m_halfPodiumWidth, m_riser3DepthPos, m_podiumHeight));
            ...
            var edgeLeftRiser2 = BRepBuilderEdgeGeometry.Create(
                new XYZ(-m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight),
                new XYZ(-m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight * 2));
            var edgeLeftRiser3 = BRepBuilderEdgeGeometry.Create(
                new XYZ(-m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2),
                new XYZ(-m_halfPodiumWidth, m_riser3DepthPos, m_podiumHeight));
            ...
            var edgeRightRiser2 = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight),
                new XYZ(m_halfPodiumWidth, m_riser2DepthPos, m_stepHeight * 2));
            var edgeRightRiser3 = BRepBuilderEdgeGeometry.Create(
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_stepHeight * 2),
                new XYZ(m_halfPodiumWidth, m_riser3DepthPos, m_podiumHeight));
