...
namespace Revit.SDK.Samples.PanelEdgeLengthAngle.CS
{
   ...
   public class SetLengthAngleParams : IExternalCommand
   {
      ...
      private InstParameters GetParams(FamilyInstance familyInstance)
      {
         ...
         {
            var errorstring = "Panel family: " + familyInstance.Id.ToString() + " '" + familyInstance.Symbol.Family.Name + "' must have instance parameters Length1, Length2, Length3, Length4, Angle1, Angle2, Angle3, and Angle4";
