...
| **Class** | `Command` |
| **Source** | `src/ModelessDialog/ModelessForm_ExternalEvent/CS/Command.cs` |
| **SDK ReadMe** | `src/ModelessDialog/ModelessForm_ExternalEvent/CS/Readme_ModelessForm_ExternalEvent.rtf` |
| **MCP rating** | 1/5 |
