...
| **Class** | `Command` |
| **Source** | `src/ModelessDialog/ModelessForm_IdlingEvent/CS/Command.cs` |
| **SDK ReadMe** | `src/ModelessDialog/ModelessForm_IdlingEvent/CS/Readme_ModelessForm_IdlingEvent.rtf` |
| **MCP rating** | 1/5 |
