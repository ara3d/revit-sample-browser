...
| **Sample** | N3P_Geometry |
| **Class** | N3P_Geometry |
| **Source** | src/N3P_Geometry/N3P_Geometry.cs |
| **MCP rating** | 5/5 |

Reports bounding-box volume/centroid and solid tessellation flags via geometry extensions.

## What it demonstrates

- [Nice3point RevitExtensions](https://github.com/Nice3point/RevitExtensions) — Geometry section
...
- Proposed tool: revit_n3p_geometry
- MCP descriptor: src/N3P_Geometry/n3p-geometry.json
