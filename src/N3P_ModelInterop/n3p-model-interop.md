...
| Field | Value |
|-------|-------|
| **Sample** | N3P_ModelInterop |
| **Class** | N3P_ModelInterop |
| **Source** | src/N3P_ModelInterop/N3P_ModelInterop.cs |
| **MCP rating** | 5/5 |

Shows ModelPath formatting and worksharing checkout status on elements.

## What it demonstrates

- [Nice3point RevitExtensions](https://github.com/Nice3point/RevitExtensions) — Model access and interoperability section
...
- Proposed tool: revit_n3p_model_interop
- MCP descriptor: src/N3P_ModelInterop/n3p-model-interop.json
