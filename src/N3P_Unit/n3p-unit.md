...
| **Sample** | N3P_Unit |
| **Class** | N3P_Unit |
| **Source** | src/N3P_Unit/N3P_Unit.cs |
| **MCP rating** | 5/5 |

Converts wall offset values using ToMillimeters, FromMillimeters, Round, and Units.Format.

## What it demonstrates

- [Nice3point RevitExtensions](https://github.com/Nice3point/RevitExtensions) — Unit section
...
- Proposed tool: revit_n3p_unit
- MCP descriptor: src/N3P_Unit/n3p-unit.json
