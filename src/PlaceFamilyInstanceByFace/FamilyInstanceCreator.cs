...
namespace Ara3D.RevitSampleBrowser.PlaceFamilyInstanceByFace.CS
{
    ...
    public class FamilyInstanceCreator
    {
        ...
        {
            var face = FaceList[faceIndex];
            var projectedStartP = SampleBrowserUtils.Project(face.Triangulate().Vertices as List<XYZ>, startP);
            var projectedEndP = SampleBrowserUtils.Project(face.Triangulate().Vertices as List<XYZ>, endP);
        ...
        public bool CheckSelectedElementSet()
        {
            ...
            foreach (var elemId in RevitDoc.Selection.GetElementIds())
            {
                ...
                ElementQuery.CheckSelectedElement(elem, RevitDoc, FaceList, FaceNameList);
                break;
            }
        ...
        public BoundingBoxXYZ GetFaceBoundingBox(int indexFace)
        {
            ...
            return new BoundingBoxXYZ { Max = maxP, Min = minP };
        }
    }
}
