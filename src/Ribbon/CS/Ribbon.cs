...
namespace Revit.SDK.Samples.Ribbon.CS
{
    ...
    public class Ribbon : IExternalApplication
    {
        ...
        private static readonly string AddInPath = typeof(Ribbon).Assembly.Location;
        ...
        public Result OnShutdown(UIControlledApplication application)
        {
            ...
            textBox.EnterPressed -= SetTextBoxValue;
        ...
        private void CreateRibbonSamplePanel(UIControlledApplication application)
        {
            ...
            pushButton = splitButton.AddPushButton(new PushButtonData("StrWallPush", "Structure Wall", AddInPath,
                "Revit.SDK.Samples.Ribbon.CS.CreateStructureWall"));
            pushButton.LargeImage =
            ...
            var pushButtonData =
                new PushButtonData("Reset", "Reset", AddInPath, "Revit.SDK.Samples.Ribbon.CS.ResetSetting");
            ...
            comboboxMember.Image =
                new BitmapImage(new Uri(Path.Combine(ButtonIconsFolder, "CircleWall.png"), UriKind.Absolute));
            comboBoxMemberData = new ComboBoxMemberData("TriangleWall", "TriangleWall");
            comboboxMember = comboboxWallShape.AddItem(comboBoxMemberData);
            comboboxMember.Image =
                new BitmapImage(new Uri(Path.Combine(ButtonIconsFolder, "TriangleWall.png"), UriKind.Absolute));
            comboBoxMemberData = new ComboBoxMemberData("SquareWall", "SquareWall");
            comboboxMember = comboboxWallShape.AddItem(comboBoxMemberData);
            comboboxMember.Image =
                new BitmapImage(new Uri(Path.Combine(ButtonIconsFolder, "SquareWall.png"), UriKind.Absolute));
            ...
            var toggleButton = radioButtonGroup.AddItem(new ToggleButtonData("Generic8", "Generic - 8\"", AddInPath,
                "Revit.SDK.Samples.Ribbon.CS.Dummy"));
            ...
            toggleButton.Image =
                new BitmapImage(new Uri(Path.Combine(ButtonIconsFolder, "ExteriorBrick-S.png"), UriKind.Absolute));
        ...
        public void DocumentCreated(object sender, DocumentCreatedEventArgs e)
        {
            ...
            comboboxLevel.DropDownOpened += AddNewLevels;
        }
        ...
        public void AddNewLevels(object sender, ComboBoxDropDownOpenedEventArgs args)
        {
            ...
            foreach (var elem in founds)
            {
                ...
                if (!alreadyContained)
                {
                    ...
                    comboboxMember.Image =
                        new BitmapImage(
                            new Uri(Path.Combine(ButtonIconsFolder, "LevelsSelector.png"), UriKind.Absolute));
                }
            }
        }
