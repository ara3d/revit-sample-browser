...
namespace BuildingCoder
{
    ...
    internal class CmdLibraryPaths : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            Util.PrintLibraryPathMap(map, "Initial application options library paths");
            ...
            Util.PrintLibraryPathMap(map, "After adding 'ImperialTestCreate' key");

            //map.set_Item( key, @"C:\Temp" ); // 2011
            map[key] = @"C:\Temp"; // 2012

            Util.PrintLibraryPathMap(map, "After modifying 'ImperialTestCreate' key");
